...
$soru = "SELECT * FROM yakinlar WHERE sayfa = 'tiyatro' ORDER BY tarih DESC";
...
<head>
    ...
    <title>Deneme</title>
    <link rel="stylesheet" href="style-tiyatro.css">
</head>
<body style="background-color: #030B16;">
    ...
    <div class="enalinan"><h1><i class="fa-solid fa-masks-theater"></i>Tiyatrolar</h1></div>
